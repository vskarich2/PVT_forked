...
if __name__ == "__main__":
    ...
    if not args.eval:
        ...
        import pickle
        all_results = pickle.load(open('/Users/vskarich/cs231n_final_project/PVT_forked_repo/PVT_forked/data/saliency_results.pkl', 'rb'))
        for result in all_results:
            trainer.plot_three_stage_saliency(result)  # etc.
