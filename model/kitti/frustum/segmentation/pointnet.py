...
class InstanceSegmentationNet(nn.Module):
    def __init__(self, num_classes, point_blocks, cloud_blocks, extra_feature_channels,
        ...
        layers, channels_point, _ = create_pointnet_components(
            blocks=point_blocks, in_channels=self.in_channels,
        ...
        layers, channels_cloud, _ = create_pointnet_components(
            blocks=cloud_blocks, in_channels=channels_point,
            width_multiplier=width_multiplier, voxel_resolution_multiplier=voxel_resolution_multiplier,model='PVTConv'
        )
...
class InstanceSegmentationPVT(InstanceSegmentationNet):
    point_blocks = ((64, 2, 15), (64, 1, 12), (128, 1, 12), (1024, 1, None))
    cloud_blocks = ()
